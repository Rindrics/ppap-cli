...
impl SendGridConfig {
    fn from_values(api_key: Option<String>, protocol: Option<String>, from_address: Option<String>) -> anyhow::Result<Self> {
        ...
        let from_address = from_address.ok_or_else(|| anyhow::anyhow!("From address is not set"))?;
        ...
        Ok(Self { api_key, protocol, from_address })
    }
